...
def main() -> int:
    ...
    label = Label(root_window, text=f"Welcome to Wuthering Waves FPS Unlocker v.{version}!"
                                    ...
                                    "\n\n1) You may need to run this program again when you change graphical settings or when there's a new patch. Thus, it is recommended that you change your desired graphical settings before running this."
